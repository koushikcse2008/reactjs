          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 footer-contact">
              ...
              <div className="social-links">
                <a href={data.twitter} className="twitter" target="_blank" rel="noreferrer"><i className="bi bi-twitter"></i></a>
                <a href={data.facebook} className="facebook" target="_blank" rel="noreferrer"><i className="bi bi-facebook"></i></a>
                <a href={data.instagram} className="instagram" target="_blank" rel="noreferrer"><i className="bi bi-instagram"></i></a>
                <a href={data.linkedin} className="linkedin" target="_blank" rel="noreferrer"><i className="bi bi-linkedin"></i></a>
              </div>
            ...
            <div className="col-lg-3 col-md-6 footer-newsletter">
              ...
              <p dangerouslySetInnerHTML={{  __html: data.news_text  }}></p>
