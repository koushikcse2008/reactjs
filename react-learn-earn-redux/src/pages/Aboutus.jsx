...
import { FetchSection, FetchTestimonial, FetchClient, FetchWork} from "../redux/slice/AboutusSlice";


const Aboutus = () => {

  const dispatch = useDispatch();
  const { sections_data, testimonials_data, clients_data, works_data } = useSelector(state => state?.aboutusSlice);
  ...
  const testimonialList = testimonials_data.map((testimonial) => 
      <>
  ...
  const clientList = clients_data.map((client) => 
    <>
    <SwiperSlide key={`client ${client.id}`}><img src={client.image_src} className="img-fluid" alt="" /></SwiperSlide>
    </>
  );
  ...
  return (
    ...
    <section id="about" className="about">
      <div className="container">
        ...
        {sections_data !== null ? (
          <>
          {
            sections_data.map((section1) => (        
              ( section1.id === 1 &&      
              <>
              <div className="col-lg-6 video-box align-self-baseline position-relative" key={`section1 ${section1.id}`}>
    ...
    <section id="work-process" className="work-process">
      <div className="container">
          ...
          {
            sections_data.map((section2) => (        
              ( section2.id === 2 &&      
              <>
                <div className="section-title" data-aos="fade-up" key={`section2 ${section2.id}`}>
        ...
        
        {
          ...
          <>
              <div className="row content" key={`work ${work.id}`}>
              { (index % 2 === 0) &&
              <>
              <div className="col-md-5" data-aos="fade-right">
                <img src={work.image_src} className="img-fluid" alt="" />
              </div>
    ...
    <section id="skills" className="skills section-bg">
      <div className="container">
        ...
        {
            sections_data.map((section3) => (        
              ( section3.id === 3 &&      
              <>
                <div className="section-title" data-aos="fade-up" key={section3.id}>
    ...
    <section id="testimonials" className="testimonials">
      <div className="container">
          ...
          {
            sections_data.map((section4) => (        
              ( section4.id === 4 &&      
              <>
                <div className="section-title" data-aos="fade-up" key={section4.id}>
