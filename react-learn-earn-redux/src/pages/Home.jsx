...
import { FetchAboutus, FetchServices } from "../redux/slice/HomeSlice";

const Home = () => {

  const dispatch = useDispatch();
  const { aboutus_data, services_data } = useSelector(state => state?.homeSlice);
