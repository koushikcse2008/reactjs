...
class Aboutus extends Component {
  ...
  componentDidMount() {
    DataService.getAboutUs().then((response) => {
      this.setState({
        secdata: response.data[0].sections,
        testimonials: response.data[1].testimonials,
        clients: response.data[2].clients,
        works: response.data[3].works,
      });
    });
  }
                ...
                <>
                  <div className="row content">
                    ...
                    {index % 2 === 1 && (
                      <>
                        <div
                          class="col-md-5 order-1 order-md-2"
                          data-aos="fade-left"
                        >
                          <img src={work.image_src} class="img-fluid" alt="" />
                        </div>
